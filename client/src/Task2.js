...
function Task2(props){
    ...
    function handleClick(){
        console.log(hint);
        if(one && three){
            Axios.put('https://backend1-api.onrender.com/update', {email: props.email, completed: "2"});
    ...
    return (
        <div id="task2">
            ...
            <br></br>
            <button onClick={handleans4}  className="button-33">Give answer</button>
            <p id="ans4"></p>
            <br></br>
            ...
            <br></br>
            <button onClick={handleans5} className="button-33">Give answer</button>
            <p id="ans5"></p>
            <br></br>
            <button onClick={handleClick}  className="button-33">Submit task 2</button>
            <p>Scroll down after submiting to see your soft skills report</p>
